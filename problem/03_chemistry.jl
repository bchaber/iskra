...
iO = create_kinetic_species("O+", 200_000,+1qe, 8mp, 100)
e  = create_kinetic_species("e-", 200_000,-1qe, 1me, 100)
using Chemistry
...
ParticleInCell.init(ParticleInCell.DensitySource(1e4δ, config.grid), O, Δt)
